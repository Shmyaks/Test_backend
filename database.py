...
class Elastic():
    ...
    @staticmethod
    def create(id: int, query_params: typing.Optional[dict] = None,
               body_params: typing.Optional[dict] = None) -> None:
        requests.post(url=Elastic._host +
                      f"/{Elastic._index}/_doc/{id}", params=query_params, json=body_params)

    @staticmethod
    def search(query_params: typing.Optional[dict] = None,
               body_params: typing.Optional[dict] = None) -> dict:
        return requests.get(url=Elastic._host + f"/{Elastic._index}/_search/",
                            params=query_params, json=body_params).json()
